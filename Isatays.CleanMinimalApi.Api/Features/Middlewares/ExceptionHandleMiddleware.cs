using Isatays.CleanMinimalApi.Api.Common.Extensions;
using Isatays.CleanMinimalApi.Core.Common.Exceptions;
using Isatays.CleanMinimalApi.Core.Common.Exceptions.Basics;
using System.Net;

namespace Isatays.CleanMinimalApi.Api.Features.Middlewares;
